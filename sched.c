 ...
 */
void
sched_cancel(struct kthread *thr)
{
    KASSERT(thr != NULL);
 ...
 */
void
sched_make_runnable(kthread_t *t)
{
    KASSERT(t != NULL);
    KASSERT(&kt_runq != t->kt_wchan);
   // KASSERT(t->kt_state == KT_RUN);
   // KASSERT(t->kt_wchan == NULL); 
